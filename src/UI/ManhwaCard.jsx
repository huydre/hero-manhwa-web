  ...
  return (
    <Col lg='3' md='4' className='flex justify-center'>
        <div className='cursor-pointer mb-2 max-w-[220px] text-left space-y-3'>
            ...
            <div className='italic font-bold text-xl pt-4 uppercase'>{item.title}</div>
            <div className='text-slate-300'>{item.chapter}</div>
            <div className='flex items-center space-x-2'>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgb(234 179 8)" class="w-6 h-6">
